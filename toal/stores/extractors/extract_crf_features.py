# from . import FeaturesContext
# from toal.stores.AbstractStore import Store

def extract_crf_features():
    # CRF sequence features
    pass
...
class SequenceExtractor(BaseExtractor):
    ...
    def extract(self, labeled_delta=None, unlabeled_delta=None):
        ...
        # TODO have a look at https://sklearn-crfsuite.readthedocs.io/en/latest/tutorial.html
